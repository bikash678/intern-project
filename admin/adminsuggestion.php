...
<div class="row">
    ...
    <div class="col-9">
        ...
        <?php
        $query = "select * from suggestion natural join user";
        include('../connection.php');
        $query_run = mysqli_query($conn, $query);
        ?>
        <div class='w-100 useradmin'>
            <h2 class="text-center mt-2">Suggestion</h2>
            <hr>
            <div class="container">
                <table class="table table boardered" style="background-color: white;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form action="deletesuggestion.php" method="POST">
                                <input type="hidden" name="id" value=" <?php echo $row['id'] ?>">
                                <th><input type="submit" name="deletesug" class="btn btn-danger" value="DELETE"></th>
                            </form>
                        </tr>
                    </tbody>
