...
<body>
    <div class="container text-center">
        <br><br>
        <h1 class="text-center text-success text-uppercase animateuse"> Academia Quiz </h1>
        <br><br><br><br>
        <table class="table text-center table-bordered table-hover">
            ...
            <tr>
                ...
                <?php
                        ...
                        $q1 = "select ans_id from phpquestions";
        ...
        <div class="container">
            ...
            <div class="col-lg-8 m-auto d-block">
                <div class="col-15 mt-1">
                    <img src="img/phpans.png" alt="" class="img-fluid" style="object-fit: contain;">
                    <br> <br>
