...
<div class="row">
    ...
    <div class="col-10">
        ...
        <div class='w-100 useradmin'>
            <h2 class="text-center mt-2">Team Members</h2>
            <hr>
            <div class="float-right my-2 mr-5">
                <a href="addteam.php" class='' style="text-decoration: none;
                font-size: 20px; font-weight: bold;">ADD Team
                ...
                <table class="table table boardered" style="background-color: white;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th> <?php echo '<img src="data:image;base64,' . base64_encode($row['img']) . '" alt="img" class="teamimg rounded-circle"' ?>
                            </th>
                            ...
                            <form action="editteam.php" method="POST">
                                ...
                                <th><input type="submit" name="editteam" class="btn btn-success" value="EDIT"></th>
                            </form>
                            <form action="deleteteam.php" method="POST">
                                <input type="hidden" name="id" value=" <?php echo $row['id'] ?>">
                                <th><input type="submit" name="deleteteam" class="btn btn-danger" value="DELETE"></th>
                            </form>
                        </tr>
                    </tbody>
